...
const SidebarContent = ({ onClose, ...rest }: SidebarProps) => {
  ...
  const tenantRoles = ['business-owner', 'gps-operator', 'it-administrator', 'data-analyst'];
  ...
  const LinkItems: Array<LinkItemProps> = [
    ...
    { name: 'Gps Data', path: '/gps-data', entity: 'gps_data', service: AccessServiceEnum.PROJECT, icon: FiDatabase },
    {
      name: 'Gps Device',
      path: '/gps-devices',
      entity: 'gps_device',
    ...
    { name: 'Server', path: '/servers', entity: 'server', service: AccessServiceEnum.PROJECT, icon: FiServer },
