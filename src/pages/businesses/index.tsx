...
function BusinessListPage() {
  ...
  const { data, error, isLoading, mutate } = useSWR<BusinessInterface[]>(
    ...
    () =>
      getBusinesses({
        relations: ['user', 'gps_device.count', 'server.count'],
      }),
  );
            ...
            <Table variant="simple">
              <Thead>
                <Tr>
                  ...
                  {hasAccess('server', AccessOperationEnum.READ, AccessServiceEnum.PROJECT) && <Th>server</Th>}
                  <Th>Actions</Th>
                </Tr>
              </Thead>
              <Tbody>
